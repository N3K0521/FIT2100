...
//elements {4, 3, 2, 1, 1, 1, ...}.
    ...
    static int series[SERIES_SIZE]; //problem line here, the error occurs because the variable series is not set as static, in this case, since the variable has been assigned values during the loop, the value would change.
